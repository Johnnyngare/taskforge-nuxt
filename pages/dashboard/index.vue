<template>
  <!-- 1. Wrap the main content in the new TaskProvider component. -->
  <TaskProvider
    v-slot="{
      tasks,
  ...
  >
    ...
    >
      ...
      <div class="mb-8">
        <!--
          THE FIX: Pass the 'tasks' data from the provider down as a prop.
          Now the banner will have the data it needs to calculate counts.
        -->
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 xl:gap-8">
        ...
        <div class="lg:col-span-8 space-y-6">
          ...
          >
            <div class="flex items-center space-x-4">
              ...
              <!-- Use pendingTasksCount directly from the provider's slot. -->
              <span
          ...
          >
            <!-- Connect the @task-added event to the handler from the provider. -->
        ...
        <div class="lg:col-span-4 space-y-6">
          ...
          <div class="transform transition-all duration-300 hover:scale-[1.02]">
            <DashboardUpcomingDeadlines :tasks="tasks" class="enhanced-card" />
          </div>
          <div class="transform transition-all duration-300 hover:scale-[1.02]">
            <DashboardProductivityStats :tasks="tasks" class="enhanced-card" />
          </div>
          <div class="transform transition-all duration-300 hover:scale-[1.02]">
            <DashboardProjectOverview :tasks="tasks" class="enhanced-card" />
          </div>
          <div class="transform transition-all duration-300 hover:scale-[1.02]">
...
// --- The script is now much cleaner! ---
...
// All task-related logic (tasks, loading, refresh, handlers, computed)
// has been moved to the <TaskProvider> component.
